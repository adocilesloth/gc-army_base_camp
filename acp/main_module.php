...
class main_module
{
	...
	function main($id, $mode)
	{
		...
		if ($request->is_set_post('submit'))
		{
			...
			$config->set('army1_tag', $this->sql_abc_clean($request->variable('apc_army1_tag', '', true)));
			...
			$config->set('armyb_tag', $this->sql_abc_clean($request->variable('apc_armyb_tag', '', true)));
			...
			$config->set('ta_tag', $this->sql_abc_clean($request->variable('apc_ta_tag', 'TA', true)));
		...
		$template->assign_vars(array(
			...
			'APC_ABC_START_TAG1'	=> $this->sql_abc_unclean($config['army1_tag']),
			...
			'APC_ABC_START_TAGB'	=> $this->sql_abc_unclean($config['armyb_tag']),
			...
			'APC_ABC_START_TAGTA'	=> $this->sql_abc_unclean($config['ta_tag']),
